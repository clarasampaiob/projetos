...
class View
{
    ...
    {
        // cria as variáveis do array $customVars - vai extrair as posições dos arrays como variável
        extract($customVars);
    ...
    // viewspath tá na página helpers e retorna o caminho da pasta View
}