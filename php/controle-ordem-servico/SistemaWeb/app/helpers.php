...
function viewsPath() { 
	return BASE_PATH . DIRECTORY_SEPARATOR . 'app' . DIRECTORY_SEPARATOR . 'view' . DIRECTORY_SEPARATOR; 
        ...
        // Base_path tem o nome do diretório do projeto
        // Directory_separator é uma constante do PHP que retorna a barra /
        // app e view é a pasta
} 
...
function dateConvert($date) { 
	...
	} /** * Calcula a idade a partir da data de nascimento * * Sobre a classe DateTime: http://rberaldo.com.br/php-usando-a-classe-nativa-datetime/ */ 
