...
<table class="table table-hover table-condensed table-bordered" style="text-align: center;">
	...
	<tr>
		<td><?php echo $mostrar[1]; ?></td> <!-- Linha onde aparecem os dados do fornecedor salvas no Banco, onde cada posição é um dado -->
		...
		<td>
			<span class="btn btn-warning btn-xs" data-toggle="modal" data-target="#abremodalFornecedoresUpdate" onclick="adicionarDado('<?php echo $mostrar[0]; ?>')">
				<!-- A função adicionarDado está enviando como parâmetros o array que recebeu os valores do SELECT feito no início dessa página, portanto tem os dados de fornecedor, e assim envia esses dados qd a função é chamda na view fornecedores.php -->
