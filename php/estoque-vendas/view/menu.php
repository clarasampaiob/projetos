      ...
      <div class="container">
        ...
        <div id="navbar" class="collapse navbar-collapse">
          ...
          <li class="dropdown" >
            ...
            <ul class="dropdown-menu">
              <!-- Se a sessão do usuário (email) não for igual a admin ele não mostra o botão de gestão do usuário -->
              <?php if($_SESSION['usuario'] == "admin"): ?> <!-- Os dois pontos é o mesmo que as chaves {} do if -->
