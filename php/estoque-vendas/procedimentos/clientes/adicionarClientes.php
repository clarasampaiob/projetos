...
echo $obj->adicionarCliente($dados); // Momento onde os dados são enviados para a função adicionarCliente que está na classe clientes.php e que fará o Insert no banco. A função receberá um array
